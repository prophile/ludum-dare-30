...
public class SpaceHams extends ApplicationAdapter {
	...
	public void create () {
        ...
        m_renderer.addSprite("title-screen", titleTexture, 1.0f);
        ...
        m_renderer.addSprite("game-over-screen", gameOverTexture, 1.0f);
        ...
        m_renderer.addSprite("destroyer", atlas.findRegion("destroyer"), 0.18f);
